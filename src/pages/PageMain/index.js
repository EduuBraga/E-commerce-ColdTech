  ...
  return (
    <>
      ...
      <Container>  
        ...
        <Offers2 tittle='Essencial para Pro PLayers' subTittle='CPU para gamers' msg='Alcance todo o seu potencial com essa máquina feita para você ganhar todas' src={cbu}></Offers2>
        ...
        <Offers4 tittle='Os melhores dos mercado' subTittle='Monitores' msg='Aprecie cores vibrantes e detalhes impressionantes com monitores feitos para você' src={monitor}></Offers4>
        <Footer></Footer>
      </Container>
    </>
  )
