  ...
  return (
    <Container>
      ...
      <div>
        ...
        <h2> {tittle}</h2>
        <p>{msg}</p>
        <Link to='/explorar/notebooks'>Confira agora</Link>
      </div>
    </Container>
  )
} 
  ...
  return (
    <ContainerReverse>
      <div>
        ...
        <h2> {tittle}</h2>
        <p>{msg}</p>
        <Link to='/explorar/cpus'>Confira agora</Link>
      </div>
  ...
  return (
    <ContainerReverse>
      <div>
        ...
        <h2> {tittle}</h2>
        <p>{msg}</p>
        <Link to='/explorar/accessories'>Confira agora</Link>
      </div>
  ...
  return (
    <Container>
      ...
      <div>
        ...
        <h2> {tittle}</h2>
        <p>{msg}</p>
        <Link to='/explorar/monitores'>Confira agora</Link>
      </div>
    </Container>
  )
} 